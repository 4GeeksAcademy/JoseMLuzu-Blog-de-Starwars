                ...
                <div className="col-md-8">
                    <div className="d-flex flex-column">
                        <div>
                            ...
                            <h3 className="card-text px-3"><strong>{planet.properties.name}</strong></h3>
                            <br />
                        ...
                        <div className="bg-danger-subtle d-flex mt-3 position-absolute bottom-0 start-0">
                            <br></br>
                            <p className="card-text ms-3 border-start ps-3 me-5"><strong>Climate:</strong> <br /> {planet.properties.climate}</p>
                            <p className="card-text border-start ps-3 me-5"><strong>Terrain:</strong> <br /> {planet.properties.terrain}</p>
                            <p className="card-text border-start ps-3 me-5"><strong>Population:</strong> <br /> {planet.properties.population}</p>
                        <div>
                            <p className="card-text border-start ps-3 me-5"><strong>Diameter:</strong> <br /> {planet.properties.diameter}</p>
                        </div>
                        </div>
                    </div>
                </div>
